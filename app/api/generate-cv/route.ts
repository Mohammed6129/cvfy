...
function buildPrompt(data: CvFormData): string {
  ...
  return `أنت كاتب سير ذاتية محترف متخصص في سوق العمل السعودي وأنظمة ATS.

${languageInstruction}

حوّل البيانات التالية إلى سيرة ذاتية كلاسيكية احترافية جاهزة للتقديم. استخدم:
- أفعالاً قوية (قاد، طوّر، حقق، حسّن، نفّذ)
- إنجازات قابلة للقياس حيثما أمكن (نسب، أرقام، نتائج)
- صياغة واضحة ومباشرة بدون حشو
- هيكل ATS-friendly: أقسام واضحة، جمل قصيرة، كلمات مفتاحية من المجال
- أسلوب مناسب لسوق العمل السعودي والخليجي
